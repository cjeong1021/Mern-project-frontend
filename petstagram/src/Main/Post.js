      ...
      <div className="postBox">
        ...
        <div className="captionSection">
          ...
          <p className="caption">
            ...
            adipisicing elit. Quam dolor nobis laborum quod ut at odio assumenda
            autem illum quo, exercitationem facilis ad blanditiis, illo earum
            repellat fugit dignissimos harum perspiciatis iste minus nisi
            voluptatum quidem cupiditate. Harum, eveniet rem!
          </p>
        </div>
        <div>
          <p className="commentSection">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Expedita
            iusto non hic accusamus temporibus quia vel, tempore rem. Quas
            beatae, vitae distinctio enim ullam eaque! Autem alias cupiditate
            reiciendis dolor!
          </p>
        </div>
        <br />
